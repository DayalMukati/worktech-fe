...
const indicatorsContainerStyles =
	'p-1 gap-1 bg-background rounded-lg';
const clearIndicatorStyles =
	'text-gray-500 p-1 rounded-md hover:text-red-800';
const indicatorSeparatorStyles = 'bg-mutated';
const dropdownIndicatorStyles =
	'p-1 hover:text-foreground text-gray-500';
const menuStyles =
...
const groupHeadingStyles =
	'ml-3 mt-2 mb-1 text-gray-500 text-sm bg-background';
