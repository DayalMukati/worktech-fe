...
const Modal = ({
  ...
  noFade,
  disableBackdrop,
  className = "bg-black-500  max-w-3xl",
  children,
  footerContent,
  centered,
  scrollContent,
  themeClass = "bg-slate-500   w-full dark:border-slate-700",
  title = "Basic Modal",
  uncontrol,
  label = "Basic Modal",
  labelClass,
      ...
      {uncontrol ? (
          ...
          <Transition appear show={showModal} as={Fragment}>
            ...
            >
              {!disableBackdrop && (
                ...
                >
                  <div className="fixed inset-0 bg-slate-400/50 backdrop-filter backdrop-blur-sm" />
                </Transition.Child>
              )}
                ...
                >
                 ...
                 bg-white text-left align-middle shadow-xl transition-all ${className}`}
                    >
                      ...
                      >
                        <h2
                          className={`capitalize leading-6 tracking-wider font-medium text-base text-white ${titleClass} `}
                        >
                          {title}
                        </h2>
        ...
        <Transition appear show={activeModal} as={Fragment}>
          <Dialog as="div" className="relative z-[99999] " onClose={onClose}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div
                className={`flex min-h-full justify-center text-center p-40 ${
                  centered ? "items-center" : "items-start "
                }`}
              >
                <Transition.Child
                 ...
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-all ${className}`}
                  >
                    {isHeader ? (
                      ...
                      >
                        <h2
                          className={`capitalize leading-6 tracking-wider font-medium text-base  ${
                      ...
                      <div className={`relative  `}>
                        <button
                          onClick={onClose}
                          className="text-[22px] absolute right-4 top-4 "
                        >
                          <Icon icon="heroicons-outline:x" />
                        </button>
                      </div>
