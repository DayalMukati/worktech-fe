...
const MetaMaskBtn: React.FC<MetaMaskBtnProps> = ({
	onClick,
	isLoading
}) => {
	return (
		<Button
			onClick={onClick}
			type='button'
			className='inline-flex items-center border-gray-200 dark:border-gray-700 bg-white hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800 mb-2 px-6 py-4.5 border rounded-lg font-medium text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-100 text-center text-sm dark:focus:ring-gray-600 dark:text-white me-2'>
			<svg
				aria-hidden='true'
				className='w-6 h-5 -ms-1 me-2'
			...
			{!isLoading ? 'Connect with MetaMask' : 'Loggin in...'}
		</Button>
	);
};
