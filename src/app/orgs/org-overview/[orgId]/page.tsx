            ...
            <div className="col-span-3">
              <div className="grid grid-rows-3 h-full">
                <div className="px-8 py-4">
                  <h1 className="mb-2 text-slate-700 text-xl">Pods</h1>
                  <div className="flex flex-wrap gap-2 mt-4 overflow-hidden">
                    {spaces.map((spaceItem, index) => {
                      return (
                        <div
                          key={index}
                          className="border-2 border-slate-300 bg-secondary shadow p-2 rounded-md min-w-[260px] cursor-pointer max-w-[300px] h-[100px]"
                          onClick={() => {
                            router.push(
                ...
                <div className="mr-10 px-8 py-4 border-t-2">
                  ...
                  {taskdata && taskdata.listAllTasks.length > 0 ? (
                    ...
                    <p className="mt-4 text-slate-500">
                      This organization doesn't have any open tasks at the
                      moment
                    </p>
                  )}
                </div>
