          ...
          <div className="flex flex-col justify-center items-center gap-1 border-slate-300 bg-card shadow-lg mx-auto p-6 border rounded-md w-full max-w-md text-card-foreground">
            ...
            >
              <div className="mb-2">
                <input
                  type="text"
                  defaultValue={data?.getUserByToken.firstName as string}
              ...
              <div className="flex justify-center items-center mb-2">
                <Icons icon="mdi:github" className="mr-1 w-8 h-8"></Icons>
                <input
                  type="text"
              ...
              <div className="flex justify-center items-center mb-2">
                <Icons
                  icon="mdi:linkedin"
                  className="mr-1 w-8 h-8 text-blue-900"
                ></Icons>
              ...
              <div className="flex justify-center items-center mb-2">
                <Icons
                  icon="mdi:twitter"
                  className="mr-1 w-8 h-8 text-blue-600"
                ></Icons>
              ...
              <div className="flex justify-center items-center mb-2">
                <Icons
                  ...
                  className="mr-1 w-8 h-8 text-primary"
                ></Icons>
