...
function Updateuser() {
    ...
    onCompleted: (data) => {
      dispatch(setUser(data.getUserByToken as any));
       reset({
        ...
        github: data.getUserByToken.github,
        linkedIn: data.getUserByToken.linkedIn,
        twitter: data.getUserByToken.twitter,
        discord: data.getUserByToken.discord,
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-1 border-slate-300 bg-card shadow-md mx-auto p-6 border rounded-md w-full max-w-md text-card-foreground">
      ...
      >
        <h2 className="font-semibold text-lg">{user.email || "Username"}</h2>
      ...
      >
        <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
          <input type="hidden" {...register("_id")} defaultValue={user?._id} />
          <div className="mb-2">
            <Input
            ...
            <Controller
              ...
              render={({ field }) => (
                <select
                  ...
                  onChange={(e) => field.onChange(parseInt(e.target.value))} // Convert the value back to a number on change
                >
          ...
          <div className="flex justify-center items-center mb-2">
            <Icons icon="mdi:linkedin" className="mr-2 w-8 h-8 text-blue-900" />
            <Input
              type="text"
          ...
          <div className="flex justify-center items-center mb-2">
            <Icons icon="mdi:twitter" className="mr-2 w-8 h-8 text-blue-400" />
            <Input
              type="text"
          ...
          <div className="flex justify-center items-center mb-2">
            <Icons icon="mdi:discord" className="mr-2 w-8 h-8 text-[#5865F2]" />
            <Input
              type="text"
